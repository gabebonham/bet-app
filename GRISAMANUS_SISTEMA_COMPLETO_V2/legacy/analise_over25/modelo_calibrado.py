...
os.makedirs('/home/ubuntu/analise_over25/previsoes_calibradas', exist_ok=True)
os.makedirs('/home/ubuntu/analise_over25/previsoes_calibradas/graficos', exist_ok=True)

class ModeloOver25Calibrado:
    def __init__(self):
        """
        Inicializa o modelo calibrado para Over 2.5 com base na análise dos resultados
        """
    ...
    def salvar_previsoes(self, previsoes_df, formato_hora_atual):
        ...
        """
        # Salvar em CSV
        arquivo_csv = f'/home/ubuntu/analise_over25/previsoes_calibradas/previsoes_over25_horas_{formato_hora_atual}.csv'
    ...
    def visualizar_previsoes(self, previsoes_df, formato_hora_atual):
        ...
        plt.savefig(f'/home/ubuntu/analise_over25/previsoes_calibradas/graficos/distribuicao_confianca_{formato_hora_atual}.png')
        plt.close()
        ...
        plt.grid(axis='y', alpha=0.3)
        plt.savefig(f'/home/ubuntu/analise_over25/previsoes_calibradas/graficos/distribuicao_campeonato_{formato_hora_atual}.png')
        plt.close()
        ...
        plt.grid(axis='y', alpha=0.3)
        plt.savefig(f'/home/ubuntu/analise_over25/previsoes_calibradas/graficos/distribuicao_hora_{formato_hora_atual}.png')
        plt.close()
        ...
        plt.title('Número de Previsões por Campeonato e Hora - Over 2.5')
        plt.tight_layout()
        plt.savefig(f'/home/ubuntu/analise_over25/previsoes_calibradas/graficos/heatmap_previsoes_{formato_hora_atual}.png')
        plt.close()
...
def gerar_pdf_previsoes(previsoes_df, formato_hora_atual):
    ...
    # Criar documento PDF
    pdf_file = f'/home/ubuntu/analise_over25/previsoes_calibradas/previsoes_over25_horas_{formato_hora_atual}.pdf'
