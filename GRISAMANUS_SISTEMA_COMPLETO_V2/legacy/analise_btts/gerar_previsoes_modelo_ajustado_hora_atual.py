...
# Gerar previsões para as próximas 3 horas a partir da hora especificada
def gerar_previsoes_proximas_horas(hora_inicial=9, num_horas=3):
    """
...
# Gerar previsões a partir da hora 09
previsoes_df = gerar_previsoes_proximas_horas(hora_inicial=9, num_horas=3)

# Salvar em CSV
previsoes_df.to_csv('/home/ubuntu/analise_btts/previsoes_ajustadas/previsoes_horas_9_10_11.csv', index=False)
...
# Criar PDF
pdf_file = "/home/ubuntu/analise_btts/previsoes_ajustadas/previsoes_btts_horas_9_10_11.pdf"
