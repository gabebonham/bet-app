...
# Gerar previsões para as próximas 3 horas
def gerar_previsoes_proximas_horas(num_horas=3):
    """
    Gera previsões para as próximas horas especificadas
    """
...
# Gerar previsões
previsoes_df = gerar_previsoes_proximas_horas(3)

# Salvar em CSV
previsoes_df.to_csv('/home/ubuntu/analise_btts/previsoes_ajustadas/previsoes_proximas_3_horas.csv', index=False)
...
# Cabeçalho
header = ["HORA", "CAMPEONATO", "COLUNA", "MERCADO", "PROBABILIDADE", "CONFIANÇA", "STAKE", "RESULTADO", "GALE"]
data.append(header)
...
# Criar PDF
pdf_file = "/home/ubuntu/analise_btts/previsoes_ajustadas/previsoes_btts_modelo_ajustado.pdf"
