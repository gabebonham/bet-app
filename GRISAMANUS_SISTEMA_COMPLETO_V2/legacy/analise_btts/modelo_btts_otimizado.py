...
os.makedirs('/home/ubuntu/analise_btts/previsoes_otimizadas', exist_ok=True)
os.makedirs('/home/ubuntu/analise_btts/previsoes_otimizadas/graficos', exist_ok=True)

class ModeloBTTSOtimizado:
    def __init__(self):
        """
        Inicializa o modelo otimizado para BTTS com base na análise dos resultados
        """
    ...
    def salvar_previsoes(self, previsoes_df, formato_hora_atual):
        ...
        """
        # Salvar em CSV
        arquivo_csv = f'/home/ubuntu/analise_btts/previsoes_otimizadas/previsoes_btts_horas_{formato_hora_atual}.csv'
    ...
    def visualizar_previsoes(self, previsoes_df, formato_hora_atual):
        ...
        plt.savefig(f'/home/ubuntu/analise_btts/previsoes_otimizadas/graficos/distribuicao_confianca_{formato_hora_atual}.png')
        plt.close()
        ...
        plt.grid(axis='y', alpha=0.3)
        plt.savefig(f'/home/ubuntu/analise_btts/previsoes_otimizadas/graficos/distribuicao_campeonato_{formato_hora_atual}.png')
        plt.close()
        ...
        plt.grid(axis='y', alpha=0.3)
        plt.savefig(f'/home/ubuntu/analise_btts/previsoes_otimizadas/graficos/distribuicao_hora_{formato_hora_atual}.png')
        plt.close()
...
def gerar_pdf_previsoes(previsoes_df, formato_hora_atual):
    ...
    # Criar documento PDF
    pdf_file = f'/home/ubuntu/analise_btts/previsoes_otimizadas/previsoes_btts_horas_{formato_hora_atual}.pdf'
