...
class ModeloOver35:
    def __init__(self):
        ...
        self.pesos_campeonatos = {
            ...
            'SUPER': 0.02,    # Incluído conforme solicitação do usuário
            'COPA': 0.01      # Incluído conforme solicitação do usuário
        }
        ...
        self.combinacoes_especificas = {
            ...
            ('SUPER', 13): 0.03,    # Estimado
            ('COPA', 14): 0.02,     # Estimado
        }
    ...
    def calcular_probabilidade(self, campeonato, coluna, hora):
        ...
        # Simplificação: colunas múltiplas de 4 têm maior probabilidade para SUPER
        if campeonato == 'SUPER' and coluna % 4 == 0:
            prob += 0.01
            
        # Simplificação: colunas múltiplas de 7 têm maior probabilidade para COPA
...
def gerar_pdf_previsoes(previsoes_df, formato_hora_atual):
    ...
    info = Paragraph("Modelo desenvolvido com base na análise dos padrões do Over 2.5 e adaptado para o mercado Over 3.5. Inclui todos os 4 campeonatos: PREMIER, EURO, SUPER e COPA.", normal_style)
